...
import strike.event.impl.KeyEvent;
...
public class ModPerspective extends ModDraggable {
    ...
    @Override
    public int getWidth() {
        return this.font.getStringWidth("[Freelook Toggled]");
    }
    ...
    public void render(final ScreenPosition pos) {
        if (this.perspectiveToggled) {
            this.font.drawString("[Freelook Toggled]", pos.getAbsoluteX(), pos.getAbsoluteY(), -1);
        }
    }
